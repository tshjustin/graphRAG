...
def _reconstitute_embeddings(
    ...
    This is essential for tracking of the embeddings and reverse engineering to understand 
    what embeddings belong to which documents - Allows for more experiments such as time 
    embedding etc 
    """
